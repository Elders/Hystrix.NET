namespace Elders.Hystrix.NET.Test.Util
{
    ...
    public class HystrixRollingPercentileTest
    {
        ...
        private static readonly IHystrixProperty<int> timeInMilliseconds = HystrixPropertyFactory.AsProperty(60000);
        private static readonly IHystrixProperty<int> numberOfBuckets = HystrixPropertyFactory.AsProperty(12); // 12 buckets at 5000ms each
        private static readonly IHystrixProperty<int> bucketDataLength = HystrixPropertyFactory.AsProperty(1000);
        private static readonly IHystrixProperty<bool> enabled = HystrixPropertyFactory.AsProperty(true);
        ...
        [TestMethod]
        public void RollingPercentileAlgorithm_Median1()
        {
            HystrixRollingPercentile.PercentileSnapshot list = new HystrixRollingPercentile.PercentileSnapshot(100, 100, 100, 100, 200, 200, 200, 300, 300, 300, 300);
            Assert.AreEqual(200, list.GetPercentile(50));
        }
        ...
        [TestMethod]
        public void RollingPercentileAlgorithm_HighPercentile()
        {
            HystrixRollingPercentile.PercentileSnapshot p = getPercentileForValues(1, 2, 3);
            Assert.AreEqual(2, p.GetPercentile(50));
            Assert.AreEqual(3, p.GetPercentile(75));
        }

        [TestMethod]
        public void RollingPercentileAlgorithm_LowPercentile()
        {
            HystrixRollingPercentile.PercentileSnapshot p = getPercentileForValues(1, 2);
            Assert.AreEqual(1, p.GetPercentile(25));
            Assert.AreEqual(2, p.GetPercentile(75));
        }

        [TestMethod]
        public void RollingPercentileAlgorithm_Percentiles()
        {
            HystrixRollingPercentile.PercentileSnapshot p = getPercentileForValues(10, 30, 20, 40);
            Assert.AreEqual(22, p.GetPercentile(30), 1.0e-5);
            Assert.AreEqual(20, p.GetPercentile(25), 1.0e-5);
            Assert.AreEqual(40, p.GetPercentile(75), 1.0e-5);
            Assert.AreEqual(30, p.GetPercentile(50), 1.0e-5);

            // invalid percentiles
            Assert.AreEqual(10, p.GetPercentile(-1));
            Assert.AreEqual(40, p.GetPercentile(101));
        }

        [TestMethod]
        public void RollingPercentileAlgorithm_NISTExample()
        {
            HystrixRollingPercentile.PercentileSnapshot p = getPercentileForValues(951772, 951567, 951937, 951959, 951442, 950610, 951591, 951195, 951772, 950925, 951990, 951682);
            Assert.AreEqual(951983, p.GetPercentile(90));
            Assert.AreEqual(951990, p.GetPercentile(100));
        }
        ...
        private static int[,] SampleData1 = new int[,]
        {
        ...
        private static int[,] SampleData2 = new int[,]
        {
            { 0, 3 }, { 43, 33 }, { 45, 11 }, { 45, 1 }, { 68, 13 }, { 88, 10 }, { 158, 68 }, { 158, 4 }, { 169, 168 }, { 267, 68 }, { 342, 68 }, { 438, 68 }, { 464, 7 }, { 504, 68 }, { 541, 6 }, { 541, 68 }, { 562, 68 }, { 581, 3 }, { 636, 68 }, { 778, 68 }, { 825, 1 }, { 859, 68 },
